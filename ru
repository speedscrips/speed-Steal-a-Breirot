here-- LocalScript: вставить в StarterPlayerScripts или в StarterGui (LocalScript)
...
-- Кнопка-тоггл (угол)
local toggleBtn = Instance.new("script")
...
-- Заголовок
local title = Instance.new("Script")
...
createMenuButton("invisibility ", 36 + 46, function()
	print("Нажата invisibility function")
end)
